!function($, wysi) {
    ...
    var tpl = {
        ...
        "lists": function(locale, options) {
            ...
            return "<li>" +
              "<div class='btn-group'>" +
                "<a class='btn btn-default" + size + "' data-wysihtml5-command='insertUnorderedList' title='" + locale.lists.unordered + "' tabindex='-1'><i class='glyphicon glyphicon-th-list'></i></a>" +
                "<a class='btn btn-default" + size + "' data-wysihtml5-command='insertOrderedList' title='" + locale.lists.ordered + "' tabindex='-1'><i class='glyphicon glyphicon-align-justify'></i></a>" +
        ...
        "link": function(locale, options) {
            ...
            return "<li>" +
              ...
              "</div>" +
              "</div>" +
              "<a class='btn btn-default" + size + "' data-wysihtml5-command='createLink' title='" + locale.link.insert + "' tabindex='-1'><i class='glyphicon glyphicon-paperclip'></i></a>" +
            "</li>";
        },
    ...
    var defaultOptions = $.fn.wysihtml5.defaultOptions = {
        ...
        stylesheets: ["../public/bootstrap-wysihtml5/wysiwyg-color.css"], // (path_to_project/lib/css/wysiwyg-color.css)
        locale: "en"
    };
